...
function onBtnSubmit() {
    if (input.value % 10 !== 0 || input.value <= 0) {
        window.alert("Please introduce another sum of money which can be divided by 10");
        return;
    }
    if (input.value % 20 === 0) {
        ...
        const amountToReceive1 = Math.floor(input.value / 20);
        window.alert(`Please take ${amountToReceive1} twenty-pound note(s) and 1 ten-pound note`);
    }
}

},{}]},["4qavH","8ZNvh"], "8ZNvh", "parcelRequire6068")
